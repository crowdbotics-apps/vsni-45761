"""
Django settings for vsni_45761 project.
...
WSGI_APPLICATION = 'vsni_45761.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "vsni_45761 API",
    "DESCRIPTION": "API documentation for vsni_45761 App",
    "VERSION": "v1",
}
